...
(function (factory) {
    ...
    defaultFileActionSettings = {
        ...
        indicatorSuccess: '<i class="glyphicon glyphicon-ok-admin text-success"></i>',
        indicatorError: '<i class="glyphicon glyphicon-exclamation-admin text-danger"></i>',
    ...
    $.fn.fileinput.defaults = {
        ...
        msgValidationErrorIcon: '<i class="glyphicon glyphicon-exclamation-admin"></i> ',
